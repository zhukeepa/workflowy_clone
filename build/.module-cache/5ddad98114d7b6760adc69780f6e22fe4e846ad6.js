  ...
  render: function() {
    return (
      React.createElement("li", null, 
        ...
        React.createElement(InputComponent, {className: "", initValue: this.props.text, keypressHandler: this.props.keypressHandler})
      )
    ); 
  } 
});
...
var InputComponent = React.createClass({displayName: "InputComponent",
  ...
  render: function() {
    return React.createElement("input", {onKeypress: this.props.keypressHandler, valueLink: this.linkState('text')});
  }
});
