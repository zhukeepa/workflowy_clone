...
var EditorComponent = React.createClass({displayName: "EditorComponent",
  ...
  render: function() {
    return React.createElement(TodoListComponent, {items: 
      this.state.todos, 
...
var TodoListComponent = React.createClass({displayName: "TodoListComponent",
      render: function() {
          ...
          for (var i = 0; i < this.props.items.size; i++) {
            ...
            ret.push( React.createElement(TodoItemComponent, {text: 
                t.get("text"), 
              ...
              keyPressHandler: 
                this.props.keyPressHandler.bind(null, path)
              }
              ));
              if (t.get("children").size > 0) {
                ret.push( React.createElement(TodoListComponent, {items: 
                    t.get("children"), 
          ...
          React.render( React.createElement(EditorComponent, {todos: 
                todos
              }
