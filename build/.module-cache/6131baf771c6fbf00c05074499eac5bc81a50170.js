  ...
  render: function() {
    return (
      React.createElement("li", null, 
        ...
        React.createElement(InputComponent, {className: "", initValue: this.props.text})
      )
    ); 
  } 
});
...
var InputComponent = React.createClass({displayName: "InputComponent",
  ...
  render: function() {
    return React.createElement("input", {onKeypress: this.props.keypressHandler, value: this.props.initValue, valueLink: this.linkState('text')});
  }
});
