  ...
  keyDownHandler: function(path, e) { 
    switch (e.which) { 
      ...
      case 37: 
        ...
        this.setState({todos: newTodos}, function () { 
          this.setFocusFromPath(oneUp(path, newTodos), 3); 
        });
      ...
      case 38: 
        ...
        var newTodos = replaceTextAtPath(this.state.todos, path, form.value)[0]; 
        this.setState({todos: newTodos}, function () { 
          this.setFocusFromPath(oneUp(path, newTodos), 1111); 
        });
        break; 
      ...
      case 39: 
        ...
        var newTodos = replaceTextAtPath(this.state.todos, path, form.value)[0]; 
        this.setState({todos: newTodos}, function () { 
          this.setFocusFromPath(oneDown(path, newTodos), 45); 
        });
      ...
      case 40: 
        ...
        var newTodos = replaceTextAtPath(this.state.todos, path, form.value)[0]; 
        this.setState({todos: newTodos}, function () { 
          this.setFocusFromPath(oneDown(path, newTodos), 19); 
        });
        break; 
    }
  },
  ...
  setFocus: function(jumpto) { 
    this.setState({ focus: true }, function() {
      ...
      if (typeof jumpto == 'number') { 
        ...
        setCursor(this.refs.input.getDOMNode(), jumpto); 
        this.refs.input.getDOMNode().setSelectionRange(jumpto, jumpto);
        this.refs.input.getDOMNode().selectionStart = jumpto; 
        console.log("selectionStart: ", this.refs.input.getDOMNode().selectionStart);
        // debugger;
      }
    }); 
  },
