...
var Todos = React.createClass({displayName: "Todos",
  ...
  render: function() { 
    return (React.createElement("span", null, this.state.todos))
    var foo = function(t) { 
      ret = (React.createElement("li", null, t.text));
      if (t.children.length != 0) { 

      }
      return (React.createElement("li", null, t.text)); 
    };
    return ( 
      React.createElement("ul", null, 
        this.state.todos.map(foo).join('')
      )
    );
  } 
});
